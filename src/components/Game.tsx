  ...
  return (
    <div className="w-full h-full relative bg-black" id="game-container">
      ...
      >
        ...
        <line x1="10.5" y1="8" x2="16" y2="8" stroke="white" strokeWidth="1.5" />
      ...
      <div
        ...
        style={{ display: 'none' }}
      >
        <div id="throw-meter-label" className="text-white text-xs font-bold tracking-widest text-center mb-1">
          Hold Q to Charge
        </div>
        <div className="relative w-56 h-4 bg-black/60 rounded-full border border-white/25 overflow-hidden">
          <div
            id="throw-meter-fill"
            style={{ position: 'absolute', top: 0, bottom: 0, left: 0, width: '0%', borderRadius: '9999px', background: 'hsl(120, 90%, 45%)' }}
          />
        </div>
